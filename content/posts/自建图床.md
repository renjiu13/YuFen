...
```json
{
  ...
  "max_size": 10,                         // 单个文件大小限制（MB）
  "keep_original_name": false,            // 是否保留原始文件名

  // ==================== 功能开关 ====================
  "enable_log": false,                    // 是否启用操作日志
  "enable_delete": false,                 // 是否允许删除图片
  "enable_file_list": false,              // 是否允许查看文件列表
  "enable_auto_clean": false,             // 是否启用自动清理过期文件

  // ==================== 文件管理 ====================
  "allowed_types": [                      // 允许上传的文件类型
    "jpg", "jpeg", "png", "gif", "webp"
  ],
  "auto_clean_days": 30,                  // 自动清理多少天前的文件
  "log_file": "./pic-bed.log"             // 日志文件保存路径
}
...
```Plain
https://github.com/renjiu13/Pic-bed
```
